        ...
        <div>
            <div className="px-4 max-w-[410px] relative" onClick={ToggleDropdown} ref={dropdownRef}>
                ...
                <input
                    ...
                    className="  w-[255px]  focus:outline-none  bg-[#293E64] text-[#A6B4CA] text-[14px]  px-3 py-2 rounded-md border border-[2px] border-[#4A618A] placeholder:text-[12px]"
                    placeholder="Select an item ..."
                />

                {isOpen && (
        <ul className="border absolute border-[#4A618A] w-[185px] h-40 overflow-y-scroll bg-[#293E64] rounded p-2">
